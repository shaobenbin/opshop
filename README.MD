...
## 🎯 初衷 // Motivation
我管理过不少公司的服务器与小应用，规模一大就很难通过笔记或零散脚本维持清晰的资产视图。为了解决这一痛点，我设计了 OpsHop：
- 用可视化 HTML 面板管理服务器与应用资产
- 用命令行通过应用名快速连接服务器并进入对应目录
- 用一份可分享的配置文件，让同事可以直接复用
...
#### 界面预览 // UI Preview
**总览界面**
![界面全览](doc/assets/界面全览.png)

**编辑服务器节点**
![服务器节点编辑](doc/assets/服务器节点编辑.png)

**编辑应用信息**
![应用编辑](doc/assets/应用编辑.png)
...
**命令行连接效果**
![通过应用名搜索连接进入服务器](doc/assets/通过应用名搜索连接进入服务器.png)
